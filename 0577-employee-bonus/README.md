...
[Problem on LeetCode](https://leetcode.com/problems/employee-bonus/)

## Performance

| Metric  | Value   | Beats |
|---------|---------|-------|
| Runtime | 1001 ms | `███████░░░` **72.4%** |
| Memory  | 0B | `██████████` **100.0%** |
...
[Browse the highest-voted solutions on LeetCode ↗](https://leetcode.com/problems/employee-bonus/solutions/?orderBy=most_votes)
