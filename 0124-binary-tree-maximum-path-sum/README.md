...
[Problem on LeetCode](https://leetcode.com/problems/binary-tree-maximum-path-sum/)
...
[Browse the highest-voted solutions on LeetCode ↗](https://leetcode.com/problems/binary-tree-maximum-path-sum/solutions/?orderBy=most_votes)
